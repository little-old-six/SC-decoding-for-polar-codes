/*****************************************************************//**
 * \file   5G_NR.h
 * \brief  5G NR polar code construction
 *
 * \author YZJ
 * \date   April 2024
 *********************************************************************/
...
static void HUAWEI_NR(int* A_list, int K_inf, int* frozen_position, int* data_position);

/****************************************program****************************************/

/**
 * .5G NR polar code construction
 *
 * \param A_list
 * \param frozen_position: earlier = less reliable
 * \param data_position: earlier = more reliable
 */
static void NR_5G(int* A_list, int* frozen_position, int* data_position)
{
	...
	if (pos == N) {
		...
		// get information and frozen bit positions
		...
		printf("\n\n<-----------HUAWEI CHANNEL SELECTION ERROR!!!!----------->\n\n");
		abort();
	}
